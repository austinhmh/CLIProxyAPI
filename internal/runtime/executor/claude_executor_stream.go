...
func (e *ClaudeExecutor) ExecuteStream(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (_ *cliproxyexecutor.StreamResult, err error) {
	...
	cpaOwnsCacheControl := cacheMode == config.ClaudePromptCacheModeLegacy && shouldEnsureCacheControl(body, cloaked, confirmedClaudeCode)
	...
	defer func() {
		if !promptCacheOwnershipTransferred && promptCacheAttempt != nil {
