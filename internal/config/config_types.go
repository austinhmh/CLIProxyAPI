...
type OpenAICompatibility struct {
	...
	// PriorityCacheWarmup gates priority native Responses on a successful five-minute warm window.
	PriorityCacheWarmup bool `yaml:"priority-cache-warmup,omitempty" json:"priority-cache-warmup,omitempty"`
