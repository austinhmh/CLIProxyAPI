...
// credentialScopedErrorCode preserves the fork's credential-wide billing
// classification while the upstream typed force-cooldown paths remain distinct.
const credentialScopedErrorCode = "credential_scoped"
