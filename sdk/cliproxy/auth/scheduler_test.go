...
func TestSchedulerPick_CodexPreferredUpstreamWebsocketPrefersWebsocketEnabledSubset(t *testing.T) {
	t.Parallel()
...
func TestSchedulerPick_XAIWebsocketPrefersWebsocketEnabledSubset(t *testing.T) {
	...
	scheduler := newSchedulerForTest(
		&RoundRobinSelector{},
		&Auth{ID: "xai-http", Provider: "xai", Attributes: map[string]string{"websockets": "false"}},
